...
def get_columns():
	columns = [
		...
		{"fieldname": "custom_lead_status", "label": _("Status"), "fieldtype": "Data", "width": 100},
		{
...
def get_data(filters):
	...
	if filters.get("custom_lead_status"):
		query = query.where(lead.custom_lead_status == filters.get("custom_lead_status"))
